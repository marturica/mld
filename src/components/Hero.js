...
import heroImg from '../images/web-dev.svg'; // Manteniendo la imagen actual.
                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">
                                Ofrecemos servicios de mudanzas locales en Arica y a nivel nacional, incluyendo envíos de todo tipo de carga entre Arica y Santiago de Chile.
                            </div>
